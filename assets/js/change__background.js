...
checkBackground()
document.querySelector(".music__add-method-file").addEventListener("click", function(){
    document.querySelector(".music__add-method-url").classList.remove("active");
    document.querySelector(".music__add-url").classList.remove("active");
    this.classList.add("active");
    document.querySelector(".music__add-file").classList.add("active");
});
document.querySelector(".music__add-method-url").addEventListener("click", function(){
    document.querySelector(".music__add-method-file").classList.remove("active");
    document.querySelector(".music__add-file").classList.remove("active");
    this.classList.add("active");
    document.querySelector(".music__add-url").classList.add("active");
});
var isMouseDown = false;
var ytb = document.querySelector(".test")
...
test.addEventListener("mousemove", function(e){
    if (isMouseDown){
        ...
        if (cx > window.innerWidth - ytb.offsetWidth){
            cx = window.innerWidth - ytb.offsetWidth
        }
        if (cy > window.innerHeight - ytb.offsetHeight){
            cy = window.innerHeight - ytb.offsetHeight
        }
        test.style.top = cy + "px"
        test.style.left = cx + "px"
    }
})
